...
🎓 Formado como técnico em Desenvolvimento de Sistemas e Estudante de Engenharia da Computação.  
📊 Interessado em **análise de dados**, **automobilismo**, **telemetria de corrida** e **inovações tecnológicas**.  
🚗 Apaixonado por projetos com **telemetria**, análise de performance e **dashboards com Python**.
...
- 🏎️ Telemetria e Performance no Automobilismo  
- ⚙️ Automação de Processos Técnicos  
- 🔌 Modelagem e Simulação de Sistemas Elétricos (OpenDSS)  
...
- **LapTrack – Telemetria F1**  
  https://github.com/VitorHashimoto21/LapTrack_F1  
